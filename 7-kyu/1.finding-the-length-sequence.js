...
console.log(lengthOfSequence([1, 2, 3, 4, 5, 6, 7], 3)); // Output: 0
console.log(lengthOfSequence([3, 3, 3, 3, 3], 3)); // Output: 5
console.log(lengthOfSequence([1, 2, 3, 4, 2, 5, 2], 2)); // Output: 6
